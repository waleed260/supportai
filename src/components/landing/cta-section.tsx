    ...
    <section className="py-24 relative">
      ...
      <div ref={ref} className="relative max-w-4xl mx-auto px-4 text-center">
        <div className={`transition-all duration-400 ${inView ? 'animate-fade-in-up' : 'opacity-0'}`}>
          <Rocket className="h-12 w-12 text-primary/30 mx-auto mb-6 animate-float" aria-hidden="true" />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/register">
              <Button size="lg" className="text-base px-10 h-12 gap-2 rounded-xs bg-primary hover:bg-primary/90 text-primary-foreground shadow-xl shadow-black/20">
                Start Free Trial <ArrowRight className="h-4 w-4" aria-hidden="true" />
              </Button>
            </Link>
            <Link href="/contact">
              <Button size="lg" variant="outline" className="text-base px-10 h-12 gap-2 rounded-xs border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/10">
                Talk to Sales
              </Button>
            </Link>
          </div>

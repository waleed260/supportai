      ...
      <div className="relative z-10 mx-auto flex w-fit rounded-xl bg-muted border border-border p-1">
        ...
        >
          {selected === "0" && (
            <motion.span
              layoutId={"switch"}
              className="absolute top-0 left-0 h-12 w-full rounded-xl border-4 shadow-sm shadow-primary/40 border-primary bg-primary"
          ...
          >
            <Card
              className={`relative border border-border ${
                plan.popular
                  ? "ring-2 ring-primary bg-accent-subtle/30"
                  : "bg-card"
              }`}
            >
              ...
              <CardContent className="pt-0">
                  ...
                  className={`w-full mb-6 p-4 text-xl rounded-xl ${
                    plan.popular
                      ...
                      : plan.buttonVariant === "outline"
                        ? "bg-foreground text-background shadow-lg shadow-foreground/30 border border-foreground"
                        : ""
                  }`}
                >
                  {plan.buttonText}
                ...
                <button
                  className="w-full mb-6 p-4 text-xl rounded-xl bg-background text-foreground border border-border shadow-lg shadow-border/50"
                >
                  Talk to Sales
                </button>
                  ...
                  <ul className="space-y-2 font-semibold">
                    {plan.includes.slice(1).map((feature, featureIndex) => (
                      <li key={featureIndex} className="flex items-center">
                        <span className="h-6 w-6 bg-background border border-primary rounded-full grid place-content-center mt-0.5 mr-3">
